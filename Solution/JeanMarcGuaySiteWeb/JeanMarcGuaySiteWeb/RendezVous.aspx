...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class=" pb-5 text-center" style="padding-top:125px;" runat="server" id="divRenseignement">
        <span><p class="text-center">Cette section apparait lorsque l'utilisateur est connecté et non-autorisé (Renseignements (Vous devez d'abord avoir été autorisé...))</p></span>
    </div>

    <div class=" pb-5 text-center" style="padding-top:125px;" runat="server" id="divRendezVous">
        <span><p class="text-center">Cette section apparait lorsque l'utilisateur est connecté et autorisé</p></span>
    </div>
