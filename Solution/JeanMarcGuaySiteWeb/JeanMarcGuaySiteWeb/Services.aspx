...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                        ...
                        <div class="col-md-8">
                           <div>
                               <div class="col-md-5" style="padding: 0px 0px 0px 0px;">
                                   <h2 class="underline1">Pourquoi consulter</h2>
                               </div>
                        </div>
        ...
        <!-- Contenu Parralax -->
        <section>
            <div class="pb-5 container-fluid bc-blue";>
                <div class="container">
                   <div class="row">
            <!-- vide -->
            <div class="col-md-6">
            ...
            <div class="col-md-6">
                <div>
                    <div class="col-md-10" style="padding: 0px 0px 0px 0px;">
                         <h2 class="underline2">N'attender pas pour consulter</h2>
                    </div>
                </div>
...
<p> D’une certaine façon, attendre à la dernière minute revient à épuiser les forces disponibles qui pourraient être utilisées en psychothérapie et servir à prévenir une détresse psychologique.
        ...
        <section>
            ...
            <div class="row">
                ...
                <h5>Le thérapeute adapte ses interventions en fonction des problèmes et des personnes qu’il rencontre</h5>
