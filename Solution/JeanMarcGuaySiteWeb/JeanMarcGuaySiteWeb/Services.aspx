...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <section>
        <div class="container-fluid bc-blue evenBiggerBox" id="evenBiggerBox">
            <div class="container divAnimation3">
                <div class="row">
                    <!-- Texte -->
                    <div class="col-md-6">
                        <div class="bigSquare">
                    ...
                    <div class="col-md-6">
                        ...
                        <p class="pt-3">La plus grande marque de respect que vous pouvez porter à votre égard est de reconnaître que vous avez besoin d'aide. Le plus beau geste d'amour pour soi et pour les siens est de se donner la liberté de mettre de son côté toutes les chances de s’en sortir.</p>
                        <p id="ImgTrigger">
    ...
    <!-- Première Rencontre -->
    <section>
        <div class="container divAnimation6 evenBiggerBox">
            <div class="row pb-5">
                <div class="col-md-12">
