...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div>
        ...
        <!-- Contenu Parralax -->
        <section>
            <div class="pb-5" style="background-image: url("http://wp2.commonsupport.com/newwp/mindron/wp-content/uploads/2018/02/services-14.jpg");
    ...
    background-size: cover;">
            ...
            <!-- Texte -->
            <div class="col-md-6">
                <h3>N'attender pas pour consulter</h3>
...
<p> D’une certaine façon, attendre à la dernière minute revient à épuiser les forces disponibles qui pourraient être utilisées en psychothérapie et servir à prévenir une détresse psychologique.
</p>
            </div>
                </div>
        ...
        <section>
            ...
            <div class="container">
            <!-- Images -->
            <div class="row pb-3" style="height:374px; max-width: 1140px; margin-top: 40px;" >
                <!-- Image 1 -->
            ...
            <!-- Texte -->
            <div class="row">
                <h3>Approche Préconisé</h3>
                <h1>Le thérapeute adapte ses interventions en fonction des problèmes et des personnes qu’il rencontre</h1>
...
1) Psychoanalytique/analytique 2) Existentielle/humaniste 
3) Systémique/interactionnelle 4) Comportementale/cognitive 

De par ses connaissances théoriques et de ses expériences des approches mentionnées ci-dessus, le thérapeute adapte ses interventions en fonction des problèmes et des personnes qu’il rencontre, et ce, en tenant compte,tant des sphères émotionnelles et cognitives que comportementales et sociales.
            </div>
            </div>
            </div>
        </section>
