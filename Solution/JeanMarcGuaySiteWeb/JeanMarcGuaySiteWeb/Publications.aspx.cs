	...
	public partial class Publications1 : System.Web.UI.Page
	{
        ...
        protected void Page_Load(object sender, EventArgs e)
		{
            ...
            foreach(Category c in categories){
                toAppend += "<div class=\"col-lg-4 portfolio-item pb-2\"><div class=\"card h-100\"><a href=\""+ c.urlRedirect +"\"><img class=\"card-img-top\" src=\""+ c.pictureUrl + "\" alt=\"\"></a><div class=\"card-body\"><h4 class=\"card-title\"><a href=\""+ c.urlRedirect +"\" >"+ c.name +"</a></h4></div></div></div>";
            }
