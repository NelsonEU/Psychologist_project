<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Desabonnement.aspx.cs" Inherits="JeanMarcGuaySiteWeb.Desabonnement" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row text-center pt-3 paddingNav2">
        <div class="col-lg-12">
            <h4>Vous êtes maintenant désabonné(e)</h4>
            <span>Vous ne receverez plus de notifications</span><br />
        </div>
    </div>
